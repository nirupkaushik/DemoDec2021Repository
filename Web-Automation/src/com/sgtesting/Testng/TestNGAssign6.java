...
public class TestNGAssign6 {
	...
	private static void createProject()
	{
		try
		{
			log.info("Create Project Initiated");
			oBrowser.findElement(By.xpath("//*[@id=\'cpTreeBlock\']/div[2]/div[1]/div[2]/div/div[2]")).click();
			Thread.sleep(2000);
			...
			Thread.sleep(5000);
			String str = oBrowser.findElement(By.xpath("//div[text()='Automation Testing ']")).getText();
			String exp = "Automation Testing";
			Assert.assertEquals(str, exp, "No Create Project");
	...
	private static void modifyProject1()
	{
		try
		{
			log.info("Modify Project Initiated");
			...
			Thread.sleep(4000);
			oBrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[4]/div[2]/div[1]/div[1]/div[2]/div[2]/div/div[1]/textarea")).sendKeys("Automation Testing");
			Thread.sleep(3000);
			...
			String str = oBrowser.findElement(By.xpath("//div[text()='Automation Testing ']")).getText();
			String exp = "Automation Testing";
			Assert.assertEquals(str, exp, "No Modify Project");
			log.info("Project Modified");
		}
		catch(Exception e)
		{
			e.printStackTrace();
	...
	private static void deleteProject()
	{
		try
		{
			log.info("Delete Project Initiated");
			oBrowser.findElement(By.xpath("//*[@id=\'cpTreeBlock\']/div[2]/div[2]/div/div[2]/div/div[1]/div[2]/div[3]/div[3]")).click();
			Thread.sleep(3000);
