...
public class TestNGAssign4 {
	...
	@Test(priority=6)
	private static void modifyCostumer()
	{
		try
		{
			log.info("Modify Customer Initiated");
			oBrowser.findElement(By.xpath("//*[@id=\'cpTreeBlock\']/div[2]/div[2]/div/div[2]/div/div[1]/div[2]/div[2]/div[4]")).click();
			Thread.sleep(3000);
			oBrowser.findElement(By.xpath("//textarea[@placeholder = 'Enter customer description...']")).click();
			oBrowser.findElement(By.xpath("//textarea[@placeholder = 'Enter customer description...']")).clear();
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//textarea[@placeholder = 'Enter customer description...']")).sendKeys("SG Software Testing Institute");
			Thread.sleep(2000);
			...
			oBrowser.findElement(By.xpath("//*[@id=\'cpTreeBlock\']/div[2]/div[2]/div/div[2]/div/div[1]/div[2]/div[2]/div[4]")).click();
			Thread.sleep(3000);
			String str = oBrowser.findElement(By.xpath("//textarea[@placeholder = 'Enter customer description...']")).getText();
			String exp = "SG Software Testing Institute";
			Assert.assertEquals(str, exp, "No Modify Costumer");
			log.info("Customer Modified");
		}
		catch(Exception e)
		{
			e.printStackTrace();
