...
public class AutomationAssign4
{
	...
	private static void createCustomer()
	{
		try
		{
			...
			oBrowser.findElement(By.id("customerLightBox_descriptionField")).sendKeys("Software Testing.");
	...
	private static void modifyCostumer()
	{
		try
		{
			...
			oBrowser.findElement(By.xpath("//*[@id='taskListBlock']/div[2]/div[2]/div[1]/div[3]/div[2]/div/div[1]/textarea")).sendKeys("SG Software Testing Institute");
			Thread.sleep(2000);
